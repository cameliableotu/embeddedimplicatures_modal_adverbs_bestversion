...
,
 newText ("<p> If there are no animals in front of the curtain, there will be a line instead. </p>")
	       ,
 newText ("<p> For instance, in the image below, there are four pairs of cats, and none of them is in front of the curtain. They all went behind the curtain, but the shadows belong to only two pairs of cats. </p>"),
